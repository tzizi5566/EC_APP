...
public final class BezierUtil {
  ...
  static void startAnimationForJd(final View v, int fromXDelta, int fromYDelta, int fx, int fy,
  ...
  static View addViewToAnimLayout(Context mContext, View view, int[] location,
      boolean wrap_content) {
    ...
    if (wrap_content) {
      ...
      if (drawable == null) {
        ...
        params = new LinearLayout.LayoutParams(drawable.getIntrinsicWidth(),
